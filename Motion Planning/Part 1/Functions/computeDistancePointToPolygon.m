...
%Enter the vertices in conterclockwise fashion: for example for the polygon
%in InfoQuiz: Geometry-HW1 %P=[1,-1;7,-1;5 3;1,3], q=[6,4]'
...
n=length(P(:,1)); %number of the vertices
